...
storiesOf('Organisms/Map', module)
  ...
  .add('default leaflet map', withInfo()(() => <LeafletMap lat={51.505} lng={-0.09} />))
  .add(
    'leaflet map with markers',
    withInfo()(() => <LeafletMap lat={51.505} lng={-0.09} markers={RandomMarkers()} />)
  )
  .add(
  ...
  .add(
    'mapbox map',
    withInfo()(() => <LeafletMap lat={51.505} lng={-0.09} markers={RandomMarkers()} showMapbox />)
  )
